# -*- coding: utf-8 -*-
#
# metadataStore documentation build configuration file, created by
# sphinx-quickstart on Sun Sep 14 16:16:32 2014.
#
...
project = u'metadataStore'
copyright = u'2014, Arman Arkilic'
...
htmlhelp_basename = 'metadataStoredoc'
...
latex_documents = [
  ('index', 'metadataStore.tex', u'metadataStore Documentation',
   u'Arman Arkilic', 'manual'),
]
...
man_pages = [
    ('index', 'metadatastore', u'metadataStore Documentation',
     [u'Arman Arkilic'], 1)
]
...
texinfo_documents = [
  ('index', 'metadataStore', u'metadataStore Documentation',
   u'Arman Arkilic', 'metadataStore', 'One line description of project.',
   'Miscellaneous'),
]
